...
('丸の内グランドホテル', '東京', '東京都千代田区丸の内1-1-1', '都心の主要駅から徒歩圏内、ビジネスにも観光にも便利なホテルです。'),
('京都東山旅館', '京都', '京都府京都市東山区清水1-1-1', '古都の風情を感じられる、落ち着いた雰囲気のホテルです。'),
('なんばグランドホテル', '大阪', '大阪府大阪市中央区難波1-1-1', '繁華街に近く、食とショッピングを楽しむのに最適なホテルです。');
